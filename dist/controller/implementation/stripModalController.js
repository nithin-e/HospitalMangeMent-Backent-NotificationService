...
class StripePaymentController {
    constructor(stripePaymentService) {
        this.createCheckoutSession = (call, callback) => __awaiter(this, void 0, void 0, function* () {
            try {
                const request = call.request;
                if (!request.appointmentData) {
                    throw new Error("Appointment data is required");
                }
                const response = yield this._stripePaymentService.createCheckoutSession(request);
                const grpcResponse = {
...
exports.default = StripePaymentController;
