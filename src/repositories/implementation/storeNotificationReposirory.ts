...
import { IStoreNotificationRepository } from "../interFace/IStoreNotificationRepository";
...
/**
 * Repository for handling notifications including:
 * - Storing new notifications
 * - Creating Stripe payment links
 * - Updating payment status
 * - Sending reschedule and admin block notifications
 */

export default class StoreNotificationRepository
  implements IStoreNotificationRepository
{
