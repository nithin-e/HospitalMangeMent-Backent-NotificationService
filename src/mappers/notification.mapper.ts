...
import { IFormattedNotification, IGrpcNotificationResponse } from "../notificationTypes";
import { INotificationsResponse } from "interfaces/types";

export class NotificationMapper {
  static toGrpcResponse(response: INotificationsResponse): IGrpcNotificationResponse {
    return {
