...
import { NotificationModel } from '../entities/notification.schema';
    ...
    try {
        ...
        switch (event.type) {
            case 'checkout.session.completed':
                ...
                if (email) {
                    ...
                    await NotificationModel.create({
                        email,
                        message:
                            'Congratulations! Your payment was successful and you are now an active member of our team.',
                        type: 'INFO',
                        isRead: false,
                        createdAt: new Date(),
                    });
            ...
            case 'payment_intent.succeeded':
                ...
                if (paymentEmail) {
                    console.log(
                        `Processing payment intent success for: ${paymentEmail}`
                    );
