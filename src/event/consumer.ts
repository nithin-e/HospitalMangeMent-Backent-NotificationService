        ...
        try {
            ...
            await ch.consume(
                ...
                async (msg) => {
                    ...
                    try {
                        console.log(
                            '📨 Received message from appointment.rescheduled queue'
                        );
                        const rescheduleData = JSON.parse(
                        ...
                        ch.ack(msg);
                        console.log(
                            '✅ Appointment reschedule notification processed successfully'
                        );
                    } catch (err) {
            ...
            await ch.consume(
                ...
                async (msg) => {
                    ...
                    try {
                        ...
                        ch.ack(msg);
                        console.log(
                            '✅ User notification processed successfully'
                        );
                    } catch (err) {
                        console.error(
                            '❌ User notification processing error:',
                            err
                        );
                        ch.nack(msg, false, false);
                    }
